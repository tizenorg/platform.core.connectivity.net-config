...
void state_object_create_and_init(void)
{
	...
	g_signal_connect(netconfigstate, "handle-device-policy-wifi",
				G_CALLBACK(handle_device_policy_wifi), NULL);
	g_signal_connect(netconfigstate, "handle-device-policy-wifi-profile",
				G_CALLBACK(handle_device_policy_wifi_profile), NULL);
